...
/***/ (function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
		...
		function App(props) {
			...
			_this.dict = {
				6: ['预言家', '花蝴蝶', '猎人', '白痴', '狼人', '狼人', '平民', '平民', '平民', '平民', '平民', '平民'],
				7: ['预言家', '花蝴蝶', '猎人', '白痴', '狼人', '狼人', '平民', '平民', '平民', '平民', '平民', '平民', '守卫', '平民'],
				8: ['预言家', '花蝴蝶', '猎人', '白痴', '狼人', '狼人', '平民', '平民', '平民', '平民', '平民', '平民', '守卫', '平民', '狼人', '平民']
			};
		...
		_createClass(App, [{
			...
			key: 'renderRows',
			value: function renderRows(count, shuffleRoles1, shuffleRoles2) {
				var res = [];
				var i = void 0;
			...
			value: function renderTable() {
				...
				var resTable = null;
				var count = this.state.peopleCount;
				var flag = true;

				if (typeof count === 'number' && count > 5 && count < 9) {
					var roles = this.dict[count];
					var shuffleRoles1 = void 0;
					var shuffleRoles2 = void 0;
					while (flag) {
						var shuffleRoles = this.shuffle(roles);
